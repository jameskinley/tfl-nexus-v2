...
> **[📄 REST API Reference (PDF)](https://github.com/jameskinley/tfl-nexus-v2/blob/main/docs/api-docs.pdf)** &nbsp;|&nbsp; **[[REST API]] (Wiki — generated from OpenAPI spec)**
>
> **[📄 MCP Docs (PDF)](https://github.com/jameskinley/tfl-nexus-v2/blob/main/docs/mcp-docs.pdf)** &nbsp;|&nbsp; **[[MCP Docs]] (Wiki)**
